<template>
    <header id="navbar" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <h1 class="in-go-home" @click="$router.push('/')" style="line-height: 0.5;font-size: 1.6em;font-family: cursive;">
            ...
            <!-- <br> <small style="font-size: xx-small;">Your Development Companion</small> -->
            <br><small style="position: relative;left: -10%; top: 14px; font-size: 11px; font-family: 'Samsung Sharp Sans Regular', sans-serif; word-spacing: 2px; color: #8ba2f0;">⚡ Making Dev Easy</small>
        </h1>
...
const navItems = [
    ...
    { text: 'Animations / Transitions', path: 'animations-and-transitions' },
